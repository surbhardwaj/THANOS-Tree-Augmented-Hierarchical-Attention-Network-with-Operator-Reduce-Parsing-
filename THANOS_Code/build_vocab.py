...
#nlp = StanfordCoreNLP('C:/Users/surbhi.bhardwaj/Desktop/Data_Sur/NLP/stanford-corenlp-full-2018-02-27/')
...
def create_vocab():
    vocab_to_index = {}
    with open(args.data_dir + '/yelp_vocab150k.pkl', 'r') as f:
        vocab = pickle.load(f)
...
if __name__ == '__main__':
    ...
    save_dict_to_json(vocab_to_index, '/home/user1/Surbhi/Yelp_data/vocab_to_index.json')
